$(document).ready(function() {
  ...
  $.ajax({
    type: "GET",
    url: `/dsaApp/planes/getPlaneByModel/${username}/Airbus`,
    contentType: "application/json",
  ...
  $("#Robustness").click(function (){
      $.ajax({
        ...
        contentType: "application/json",
        data: JSON.stringify({modificationCode: "0", playerName: username, planeModelModel: "Airbus"}),
        success: function (data) {
          location.reload();
        },
        error: function (xhr, ajaxOptions, thrownError) {
          console.log('Could not log out')
             ...
             $.ajax({
               ...
               url: `/dsaApp/planes/addUpgradeToPlayer`,
               contentType: "application/json",
               data: JSON.stringify({modificationCode: "1", playerName: username, planeModelModel: "Airbus"}),
               success: function (data) {
                 location.reload();
               },
               error: function (xhr, ajaxOptions, thrownError) {
    ...
    $("#Speed").click(function (){
          $.ajax({
            ...
            url: `/dsaApp/planes/addUpgradeToPlayer`,
            contentType: "application/json",
            data: JSON.stringify({modificationCode: "2", playerName: username, planeModelModel: "Airbus"}),
            success: function (data) {
              location.reload();
            },
            error: function (xhr, ajaxOptions, thrownError) {
    ...
    $("#Fuel").click(function (){
          $.ajax({
            ...
            url: `/dsaApp/planes/addUpgradeToPlayer`,
            contentType: "application/json",
            data: JSON.stringify({modificationCode: "3", playerName: username, planeModelModel: "Airbus"}),
            success: function (data) {
              location.reload();
            },
            error: function (xhr, ajaxOptions, thrownError) {
    ...
    $("#Weight").click(function (){
          $.ajax({
            ...
            url: `/dsaApp/planes/addUpgradeToPlayer`,
            contentType: "application/json",
            data: JSON.stringify({modificationCode: "4", playerName: username, planeModelModel: "Airbus"}),
            success: function (data) {
              location.reload();
            },
            error: function (xhr, ajaxOptions, thrownError) {
